...
// Flatten and deduplicate outfits from different collections
const allOutfits = Array.from(
  new Map(
    featuredCollections
      .flatMap(collection => collection.outfits)
      .map(outfit => [outfit.id, outfit])
  ).values()
).filter(outfit => outfit.category !== 'TV Series'); // Filter out TV series outfits
    ...
    <Layout>
      ...
      <div className="bg-sanav/5 py-12">
        <div className="container mx-auto px-4 sm:px-6">
          <h1 className="text-3xl font-bold mb-4">Celebrity Outfits</h1>
          <p className="text-muted-foreground max-w-2xl">
            Discover and shop outfits worn by your favorite celebrities at events, red carpets, 
