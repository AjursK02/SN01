...
// Flatten outfits from different collections
const allOutfits = featuredCollections
  .flatMap(collection => collection.outfits)
  // Only include outfits with a movie-like person
  .filter(outfit => 
    !outfit.person.includes('Euphoria') && 
    !outfit.person.includes('Succession') &&
    !outfit.person.includes('White Lotus') &&
    !outfit.person.includes('Stranger Things') &&
    !outfit.person.includes('The Crown')
  );
    ...
    <Layout>
      ...
      <div className="bg-sanav/5 py-12">
        <div className="container mx-auto px-4 sm:px-6">
          <h1 className="text-3xl font-bold mb-4">Movie Outfits</h1>
          <p className="text-muted-foreground max-w-2xl">
            Find and shop the exact outfits and similar styles worn by characters in your favorite movies.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between gap-4">
            ...
            <form onSubmit={handleSearch} className="relative max-w-md w-full">
              <input
                type="text"
                placeholder="Search by movie or outfit..."
